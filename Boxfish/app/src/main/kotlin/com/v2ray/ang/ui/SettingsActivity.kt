...
class SettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.title_settings) // Title
        ...
        // Start listening to the changes in the settings
        settingsViewModel.startListenPreferenceChange()
    }

    class SettingsFragment : PreferenceFragmentCompat() {

        private val perAppProxy by lazy { findPreference<SwitchPreferenceCompat>(AppConfig.PREF_PER_APP_PROXY) }
        ...
        override fun onStart() {
            ...
            delayTestUrl?.summary =
                settingsStorage.decodeString(AppConfig.PREF_DELAY_TEST_URL, AppConfig.DELAY_TEST_URL)
    ...
    fun onModeHelpClicked() {
        Utils.openUri(this, AppConfig.BOXFISH_WIKI_MODE)
    }
