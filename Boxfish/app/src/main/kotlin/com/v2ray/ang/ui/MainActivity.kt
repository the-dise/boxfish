...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Register predictive back gesture if available
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    // Handle back navigation for pre-Android 13
                    onBackPressedDispatcher.onBackPressed()
                }
            })
        }
        ...
        binding.layoutTest.setOnClickListener {
            if (mainViewModel.isRunning.value == true) {
                ...
                setTestIcon(R.drawable.ic_test_web_sync_24)
                mainViewModel.testCurrentServerRealPing()
            } else {
                setTestState(getString(R.string.connection_test_fail))
                setTestIcon(R.drawable.ic_test_web_remove_24)
            }
        }
    ...
    private fun setupViewModel() {
        ...
        mainViewModel.updateTestResultAction.observe(this) { testResult ->
            ...
            setTestIcon(R.drawable.ic_test_web_check_24)
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        R.id.del_all_config -> {
            MaterialAlertDialogBuilder(this)
                .setTitle(resources.getString(R.string.del_config_confirm_title))
                .setMessage(resources.getString(R.string.del_config_confirm_all))
        ...
        R.id.del_duplicate_config -> {
            MaterialAlertDialogBuilder(this)
                .setTitle(resources.getString(R.string.del_config_confirm_title))
                .setMessage(resources.getString(R.string.del_config_confirm_duplicate))
        ...
        R.id.del_invalid_config -> {
            MaterialAlertDialogBuilder(this)
                .setTitle(resources.getString(R.string.del_config_confirm_title))
                .setMessage(resources.getString(R.string.del_config_confirm_invalid))
...
//        }
    ...
    private fun setTestIcon(iconResId: Int?) {
        if (iconResId != null) {
            binding.ivTestState.setImageResource(iconResId)
        } else {
            binding.ivTestState.setImageResource(R.drawable.ic_cloud_sync_24)
        }
    }
